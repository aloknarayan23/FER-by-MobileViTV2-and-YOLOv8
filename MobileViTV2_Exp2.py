...
# Freezing initial 3 layers of the pretrained model.
...
joblib.dump(model, 'MViTV2_Exp2.pkl') 
...
plt.savefig('MViTV2_Exp2_confusion_matrix.png')  
...
with open('MViTV2_Exp2_classification_report.txt', 'w') as f:
    f.write(report)
